    ...
    <div className="min-h-screen bg-linear-to-br from-planet-950 via-slate-950 to-slate-900">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/"
            className=" inline-flex items-center gap-3 bg-transparent text-primary-500 font-black px-12 py-6 rounded-4xl text-xl border border-primary-500 hover:bg-primary-500 hover:text-slate-950 hover:shadow-primary/25 hover:scale-105 transition-all duration-300 "          >
